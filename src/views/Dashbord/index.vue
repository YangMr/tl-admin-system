...
//   // if (lineOptions.value.series && lineOptions.value!.series[0].data) {
//   lineOptions.value.series[0].data = [10, 22, 30, 40, 50, 60, 70]
//   // }
// }
</script>
...
<template>
  <div class="index-page">
    ...
    <el-card class="box-card">
      ...
      <div class="flex">
        <div class="flex-item">
          <EchartsItem class="line-chart" :chart-option="lineOptions" />
          <!-- <div class="line-chart" ref="lineChartRef"></div> -->
        </div>
        <div class="flex-item">
          <EchartsItem class="bar-chart" :chart-option="barOptions" />
